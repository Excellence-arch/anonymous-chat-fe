...
export const chatAPI = {
  ...
  sendMessage: (receiverId: string, content: string) => api.post("/chat/send", { receiverId, content }),
  searchUsers: (query: string) => api.get(`/chat/search?query=${encodeURIComponent(query)}`),
}
